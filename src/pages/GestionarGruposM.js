...
class GestionarGruposM extends Component{
    ...
    async componentDidMount(){
        await axios.get(API_URL + "/api/Grupo/usuarios/"+this.context.GlobalState.user.id+"/grupos").then((response)=>{
    ...
    async Selected(id,codigo){
        await axios.get(API_URL + "/api/Grupo/usuarios/"+id).then((response)=>{
            console.log(response.data.data)
            this.setState(PrevState =>({
    ...
    async AgregarGrupo(id){
        await axios.post(API_URL + "/api/Grupo/"+this.state.grupoC.toString()+"/"+id.toString(),{}).then((response)=>{
            this.setState(PrevState =>({
                view:false
            }));
    ...
    async EliminarGrupo(id){
        ...
        await axios.delete(API_URL + "/api/Grupo/"+this.state.grupoId+"/usuarios/"+id).then((response)=>{
